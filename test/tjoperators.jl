    ...
    for slave_fermion in (false, true)
        for particle_symmetry in [Trivial, U1Irrep],
            ...
            if (particle_symmetry, spin_symmetry) in implemented_symmetries
                ...
                O_triv = singlet_plus_singlet_min_3site(ComplexF64, Trivial, Trivial; slave_fermion)
                test_operator(O, O_triv; L = 5)

                O = singlet_plus_singlet_min_4site(ComplexF64, particle_symmetry, spin_symmetry; slave_fermion)
                O_triv = singlet_plus_singlet_min_4site(ComplexF64, Trivial, Trivial; slave_fermion)
                test_operator(O, O_triv; L = 5)
            else
        ...
        for particle_symmetry in [Trivial, U1Irrep],
            ...
            if (particle_symmetry, spin_symmetry) in implemented_symmetries
                ...
                if spin_symmetry !== SU2Irrep
                    ...
                    @test_throws ArgumentError u_num(
                        particle_symmetry, spin_symmetry;
                        slave_fermion
                    )
                    @test_throws ArgumentError d_num(
                        particle_symmetry, spin_symmetry;
                        slave_fermion
                    )
                end
                ...
                if particle_symmetry == Trivial
                    ...
                    @test_throws ArgumentError u_min_d_min(
                        particle_symmetry, spin_symmetry;
                        slave_fermion
                    )
                    @test_throws ArgumentError d_min_u_min(
                        particle_symmetry, spin_symmetry;
                        slave_fermion
                    )
                ...
                if particle_symmetry == Trivial && spin_symmetry == Trivial
                    ...
                    @test_throws ArgumentError u_min_u_min(
                        particle_symmetry, spin_symmetry;
                        slave_fermion
                    )
                    @test_throws ArgumentError d_min_d_min(
                        particle_symmetry, spin_symmetry;
                        slave_fermion
                    )
                ...
                O_ijk = singlet_plus_singlet_min_3site(particle_symmetry, spin_symmetry; slave_fermion)
                ...
                if spin_symmetry == Trivial
                    ...
                    @test_throws ArgumentError S_min(
                        particle_symmetry, spin_symmetry;
                        slave_fermion
                    )
                    @test_throws ArgumentError S_x(
                        particle_symmetry, spin_symmetry;
                        slave_fermion
                    )
                    @test_throws ArgumentError S_y(
                        particle_symmetry, spin_symmetry;
                        slave_fermion
                    )
                    if spin_symmetry != U1Irrep
                        @test_throws ArgumentError S_z(
                            particle_symmetry, spin_symmetry;
                            slave_fermion
                        )
                    end
