...
The gates with complex matrix elements — [`pauli_y`](@ref), [`phase_shift`](@ref), [`s_gate`](@ref), [`t_gate`](@ref), [`rotation_x`](@ref), [`rotation_z`](@ref), [`cy`](@ref), [`cs`](@ref), [`cphase`](@ref), [`iswap`](@ref), [`ecr`](@ref), [`rotation_xx`](@ref), [`rotation_yy`](@ref), [`rotation_zz`](@ref) and [`rotation_zx`](@ref) — throw an `ArgumentError` when requested with a real `eltype`.
